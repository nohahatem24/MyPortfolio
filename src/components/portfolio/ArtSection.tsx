...
// --- Image Imports (No changes needed) ---
...
const ArtCard = React.memo(({ art, onClick }: { art: ArtPiece; onClick: () => void }) => {
    ...
    return (
        <div
            ...
            onClick={onClick}
        >
            <div className="relative flex-grow overflow-hidden bg-gray-100 dark:bg-gray-700/50 p-3">
                {showTwoImages ? (
                    ...
                    <img
                        src={art.images[0]}
                        alt={art.title}
                        className="w-full object-cover aspect-square rounded-lg transition-transform duration-500 group-hover:scale-105"
                        loading="lazy"
