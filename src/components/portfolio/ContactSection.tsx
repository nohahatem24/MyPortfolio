      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid lg:grid-cols-2 gap-12 transition-all duration-1000 delay-200 ${
          ...
          <div className="bg-white/60 dark:bg-gray-800/60 rounded-2xl p-8 shadow-lg backdrop-blur-sm">
            ...
            {formStatus === 'idle' && (
              <div className="mt-6 p-4 bg-pink-50 dark:bg-purple-900/20 rounded-lg">
                <p className="text-sm text-pink-800 dark:text-purple-300">
                  This form will open your email client to send the message to nohahatem.nh@gmail.com.
                </p>
              </div>
            )}
          </div>
