  ...
  const certificates: Certificate[] = [
    {
      ...
      issuer: 'Google',
      issueDate: '2023',
      image: 'https://pub-cdn.sider.ai/u/U0NWHJ61Y0X/web-coder/688770f38f67a34944cfc801/resource/70e8a2c3-69e4-44d6-8331-81f32b96e47b.jpg'
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certificates.map((cert, index) => (
            <div 
              key={index} 
              className={`bg-white/60 dark:bg-gray-800/60 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-500 backdrop-blur-sm group ${
                isVisible 
