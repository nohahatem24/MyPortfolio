        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className={`transition-all duration-1000 ease-in-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <motion.p 
              ...
              className="mb-4 text-xl font-semibold text-pink-600 dark:text-purple-400 flex items-center justify-center lg:justify-start"
            >
            ...
            <motion.h1 
              ...
              className="text-4xl font-extrabold tracking-tighter text-gray-900 dark:text-white sm:text-5xl md:text-6xl lg:text-7xl"
            >
            ...
            <motion.div 
              ...
              className="mt-10 flex justify-center space-x-6 lg:justify-start"
            >
              ...
              <a href="https://linkedin.com/in/noha-hatem-192597387" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="transform-gpu text-gray-500 transition-all duration-200 hover:scale-125 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
                <Linkedin className="h-7 w-7" />
              </a>
              <a href="https://behance.net/nohahatem24/appreciated" target="_blank" rel="noopener noreferrer" aria-label="Behance" className="transform-gpu text-gray-500 transition-all duration-200 hover:scale-125 hover:text-[#053eff] dark:text-gray-400 dark:hover:text-[#053eff]">
                <Shapes className="h-7 w-7" />
              </a>
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=noha.hatem.alsayed@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email" className="transform-gpu text-gray-500 transition-all duration-200 hover:scale-125 hover:text-pink-600 dark:text-gray-400 dark:hover:text-pink-400">
