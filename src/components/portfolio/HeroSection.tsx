        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className={`flex flex-wrap justify-center lg:justify-start gap-3 text-sm md:text-base text-gray-600 dark:text-gray-400 mb-8 transition-all duration-1000 delay-300 ${
              ...
              <span className="bg-white/60 dark:bg-gray-800/60 px-4 py-2 rounded-full shadow-sm backdrop-blur-sm">Artist</span>
            ...
            <div className="relative">
              ...
              <div className="w-80 h-80 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-pink-200 to-purple-200 dark:from-pink-800 dark:to-purple-800 p-2 shadow-2xl">
                <div className="w-full h-full rounded-full bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm flex items-center justify-center">
                  ...
                  <img 
                    src="https://pub-cdn.sider.ai/u/U0NWHJ61Y0X/web-coder/688770f38f67a34944cfc801/resource/17619ddf-3cd9-45c8-9546-a1e8d45833ae.jpg"
